// 函数节流
  ...
  $.fn.searchInput = function(options){
    ...
    function addClearBtn(){
      var _this = this;
      var $clearDom = $('<i class="clear-input-btn"></i>')
              .css('display','none');
      $clearDom.on('tap', function(){
        _this.val('');
        $(this).css('display','none');
      });
      $clearDom.appendTo($('.search-box'));
      return $clearDom;
    }
    ...
    return this.each(function(){
      ...
      // 添加清空表单按钮
      var $clearBtn = addClearBtn.call($('.search-box input'));
      ...
      var input_fn = control(function(ajaxUrl, keyword){
        ...
        var list = '<ul><li><span>123444</span></li></ul>';
       ...
       /* $.ajax({
          ...
          success: function(res){
            ...
            $.each(data, function(index, value){
              list += '<li><i class="text-icon icon-search"></i><span>'+ value +'</span></li>'
            });
            list += '</ul>';
